import os
from pymilvus import Milvus, Collection, CollectionSchema, FieldSchema, DataType,MilvusClient  
from visual_bge.visual_bge import Visualized_BGE
import numpy as np
...
# {
#   "id": 101,                    // 自动生成的
#   "vector": [0.12, -0.34, ...], // 成百上千个浮点数
#   "image_path": "./data/dragon/dragon_01.png"
# }
# 创建集合 Schema
